...
An end-to-end data analysis project to explore sales performance at Walmart using SQL for querying, and Python libraries like Pandas, NumPy, Seaborn, Matplotlib, and SciPy for data analysis, hypothesis testing, and visualization.
